...
@RestController
@RequestMapping("/api/xamsambokk-kafka")
public class XamsambokkKafkaResource {
    private final Logger log = LoggerFactory.getLogger(XamsambokkKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public XamsambokkKafkaResource(KafkaProperties kafkaProperties) {
